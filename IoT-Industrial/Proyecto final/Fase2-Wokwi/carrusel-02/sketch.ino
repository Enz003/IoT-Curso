/* ============================================================================
 *  Smart Carousel Parking — Gateway ESP32 (carrusel-02)
 *  Broker: HiveMQ Cloud (TLS, puerto 8883)
 *  Payload: JSON anidado con objetos "slots" y "motor"
 *  Topic:   carrusel/carrusel-02/telemetria
 * ============================================================================
 *
...
const char* DEVICE_ID = "carrusel-02";
const char* TOPIC     = "carrusel/carrusel-02/telemetria";
...
void setup() {
  ...
  delay(200);
  Serial.println();
  Serial.println("=== Smart Carousel Parking - Gateway ESP32 (carrusel-02) ===");
